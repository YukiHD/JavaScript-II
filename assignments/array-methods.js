...
//   firstNamesAllCaps.push(upper.first_name.toUpperCase());
...
// runners.filter(function(filterSize) {
//   if (filterSize.shirt_size === "L") {
//     runnersLargeSizeShirt.push(filterSize);
//   }
...
// let ticketPriceTotal = runners.reduce(function(pV, cV) {
//   return pV + cV.donation;
// }, 0);
